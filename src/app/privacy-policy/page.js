...
export default function PrivacyPolicy() {
    return (
        <main className="min-h-screen bg-black text-white selection:bg-emerald-500/30 font-sans p-4 sm:p-8 overflow-x-hidden">
            {/* Background Effects */}
            <div className="fixed inset-0 z-0">
                <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-emerald-600/10 rounded-full mix-blend-screen filter blur-[150px] opacity-60"></div>
                <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-teal-600/10 rounded-full mix-blend-screen filter blur-[150px] opacity-60"></div>
            ...
            <div className="max-w-3xl mx-auto relative z-10 pt-8 pb-20">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-12 border-b border-white/10 pb-8">
                    <h1 className="text-3xl sm:text-5xl font-black uppercase tracking-tighter mb-4 flex items-center gap-4">
                        <ShieldCheck className="w-10 h-10 sm:w-14 sm:h-14 text-emerald-500" />
                ...
                <motion.div
                    ...
                    className="space-y-10 text-zinc-300 leading-loose"
                >
                    <section>
                        <h2 className="text-xl font-bold text-white uppercase tracking-widest mb-4">1. Collecte des données</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white uppercase tracking-widest mb-4">2. Finalité du traitement</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white uppercase tracking-widest mb-4">3. Conservation des données</h2>
                        <p>
